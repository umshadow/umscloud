window.allArticles = [
    {
        id: 1,
        article: 'skolko-stoyat-zanyatiya-s-repetitorom-po-matematike',
        articleTitle: 'Сколько стоит репетитор по&nbsp;математике в&nbsp;2026&nbsp;году?',
        articleDescription: 'Почему один репетитор берёт 500&nbsp;₽ за&nbsp;занятие, а&nbsp;другой&nbsp;&mdash; 5&nbsp;000&nbsp;₽?',
        date: '2025-09-29',
        image: 'https://static.tildacdn.com/tild6431-3831-4830-b461-333232383164/4.jpg',
        categories: ['Выбор репетитора'],
        author: 'svetlana-savinih'
    },
    {
        id: 2,
        article: 'podgotovka-k-ege-repetitor-ili-onlajn-shkola',
        articleTitle: 'Подготовка к&nbsp;ЕГЭ: репетитор или онлайн-школа',
        articleDescription: 'Как помочь ребёнку выбрать лучший способ подготовки к&nbsp;ЕГЭ?',
        date: '2025-10-14',
        image: 'https://static.tildacdn.com/tild3830-3136-4234-b634-376163346166/2.jpg',
        categories: ['ЕГЭ'],
        author: 'ekaterina-maslennikova'
    },
    {
        id: 3,
        article: 'kak-vibrat-repetitiora-po-matematike-za-5-shagov',
        articleTitle: 'Как выбрать репетитора-математика за&nbsp;5&nbsp;шагов?',
        articleDescription: 'Рассказываем, как выбрать репетитора, чтобы занятия приносили результат и&nbsp;уверенность в&nbsp;себе',
        date: '2025-10-27',
        image: 'https://static.tildacdn.com/tild3466-3039-4037-a634-323239313265/5.jpg',
        categories: ['Выбор репетитора'],
        author: 'ekaterina-maslennikova'
    },
    {
        id: 4,
        article: 'temy-itogovogo-sochineniya-2025-napravleniya-proizvedeniya-i-argumenty',
        articleTitle: 'Темы итогового сочинения 2025: комплект тем, направления и&nbsp;аргументы',
        articleDescription: 'Разберем ключевые аспекты подготовки к&nbsp;итоговому сочинению 2025 года',
        date: '2025-11-14',
        image: 'https://static.tildacdn.com/tild3736-6139-4931-b733-386431663931/6.png',
        categories: ['ЕГЭ'],
        author: 'ekaterina-maslennikova'
    },
    {
        id: 5,
        article: 'raspisanie-oge-2026-goda-daty-ekzamenov-dosrochnyj-i-osnovnoj-periody',
        articleTitle: 'Расписание ОГЭ-2026 года: даты экзаменов',
        articleDescription: 'ОГЭ&nbsp;&mdash; первый серьезный экзамен в&nbsp;жизни девятиклассников, а&nbsp;значит, к&nbsp;нему нужно подойти со&nbsp;всей ответственностью',
        date: '2025-11-21',
        image: 'https://static.tildacdn.com/tild6134-3933-4262-b936-646230326565/7_2.jpg',
        categories: ['Новости'],
        author: 'kseniya-lunegova'
    },
    {
        id: 6,
        article: 'raspisanie-ege-2026-goda-daty-provedeniya-ekzamenov',
        articleTitle: 'Расписание ЕГЭ-2026 года: даты проведения экзаменов',
        articleDescription: '15&nbsp;октября Минпросвещения и&nbsp;Рособрнадзор представили предварительное расписание ЕГЭ-2026',
        date: '2025-11-21',
        image: 'https://static.tildacdn.com/tild3630-3937-4331-a466-633962393964/8_1.jpg',
        categories: ['Новости'],
        author: 'darya-tyurina'
    },
    {
        id: 7,
        article: 'kak-napisat-itogovoe-sochinenie-2025-i-poluchit-zachyot',
        articleTitle: 'Как написать итоговое сочинение — 2025 и&nbsp;получить «зачёт»',
        articleDescription: 'Совсем скоро выпускникам нужно будет писать итоговое сочинение',
        date: '2025-11-24',
        image: 'https://static.tildacdn.com/tild6665-3863-4837-b133-336462643133/9_3.png',
        categories: ['ЕГЭ'],
        author: 'ekaterina-maslennikova'
    },
    {
        id: 8,
        article: 'kak-podgotovitsya-k-oge-s-nulya-za-polgoda',
        articleTitle: 'Как подготовиться к&nbsp;ОГЭ с&nbsp;нуля за&nbsp;полгода?',
        articleDescription: 'Прокачаться сразу по&nbsp;четырём предметам сложно, но&nbsp;реально. Главное&nbsp;&mdash; начать прямо сейчас.',
        date: '2025-12-09',
        image: 'https://static.tildacdn.com/tild3835-3933-4861-a631-636438663739/d_1.png',
        categories: ['ОГЭ'],
        author: 'darya-tyurina'
    },
    {
        id: 9,
        article: 'kak-podgotovitsya-k-ege-s-nulya-za-polgoda',
        articleTitle: 'Как подготовиться к&nbsp;ЕГЭ с&nbsp;нуля за&nbsp;полгода?',
        articleDescription: 'Что делать, если до&nbsp;ЕГЭ осталось полгода, а&nbsp;из&nbsp;знаний&nbsp;&mdash; только названия предметов, выбранных для сдачи?',
        date: '2025-12-16',
        image: 'https://static.tildacdn.com/tild6364-6236-4463-a665-346263613135/d_1.png',
        categories: ['ЕГЭ'],
        author: 'kseniya-lunegova'
    },
    {
        id: 10,
        article: 'oshibki-v-russkom-yazyke-kotorye-mozhno-zametit-v-novogodnikh-filmakh',
        articleTitle: 'Ошибки русского языка в&nbsp;фильмах: новогодняя версия',
        articleDescription: 'Разбираем распространённые ошибки в&nbsp;русском языке из&nbsp;известных новогодних фильмов.',
        date: '2025-12-22',
        image: 'https://static.tildacdn.com/tild6435-3834-4935-a239-326433633535/d_2.png',
        categories: ['Предметы'],
        author: 'kseniya-lunegova'
    },
    {
        id: 11,
        article: 'itogovoe-sobesedovanie-monolog-i-dialog',
        articleTitle: 'Устное собеседование ОГЭ 2026: как сдать монолог и&nbsp;диалог',
        articleDescription: 'Подготовка к&nbsp;итоговому собеседованию ОГЭ-2026: формат, структура монолога и&nbsp;диалога, типичные ошибки и&nbsp;практические советы. Как набрать 10+&nbsp;баллов за&nbsp;15&nbsp;минут? Узнайте и&nbsp;подготовьтесь с&nbsp;Умскул Репетиторами!',
        date: '2026-01-12',
        image: 'https://static.tildacdn.com/tild3564-3533-4261-a538-306336316439/d_1.png',
        categories: ['ОГЭ'],
        author: 'kseniya-lunegova'
    },
    {
        id: 12,
        article: 'kriterii-itogovogo-sobesedovaniya-2026',
        articleTitle: 'Критерии итогового собеседования — 2026',
        articleDescription: 'Совсем скоро каждого девятиклассника ждёт самый первый экзамен. Причём проходить он&nbsp;будет в&nbsp;устной форме, а&nbsp;от&nbsp;результата зависит аттестация.',
        date: '2026-01-19',
        image: 'https://static.tildacdn.com/tild6166-3263-4032-b664-643334393936/d_1.jpg',
        categories: ['ОГЭ'],
        author: 'ekaterina-maslennikova'
    },
    {
        id: 13,
        article: 'stoit-li-doveryat-vybor-repetitora-rebyonku',
        articleTitle: 'Стоит ли доверять выбор репетитора ребёнку',
        articleDescription: 'Старшеклассники ориентируются в&nbsp;онлайн-пространстве гораздо лучше, чем многие взрослые. И&nbsp;часто сами находят себе нужные ресурсы&nbsp;&mdash; от&nbsp;бесплатных каналов до&nbsp;онлайн-курсов и&nbsp;репетиторов.',
        date: '2026-01-19',
        image: 'https://static.tildacdn.com/tild3162-6433-4634-b961-346131383530/d_3.png',
        categories: ['Выбор репетитора'],
        author: 'svetlana-savinih'
    },
    {
        id: 14,
        article: 'kak-probudit-interes-k-uchyobe-u-rebyonka-sovety-repetitorov',
        articleTitle: 'Как пробудить интерес к учёбе у ребёнка: советы репетиторов',
        articleDescription: 'Берём в&nbsp;руки бубен, готовим стендап-программу,&nbsp;&mdash; и&nbsp;погнали! А&nbsp;как ещё можно заставить детей проявить интерес к&nbsp;учёбе?',
        date: '2026-01-26',
        image: 'https://static.tildacdn.com/tild3565-6162-4664-b762-326365346462/d_3.png',
        categories: ['Советы'],
        author: 'svetlana-savinih',
        forTutor: true
    },
    {
        id: 15,
        article: 'repetitor-ili-kursy-chto-luchshe-dlya-podgotovki-k-oge',
        articleTitle: 'Репетитор или курсы: что лучше для подготовки к&nbsp;ОГЭ?',
        articleDescription: 'Курсы или репетитор: что лучше для подготовки к&nbsp;ОГЭ? Разбор плюсов и&nbsp;минусов занятий с&nbsp;репетитором и&nbsp;онлайн-курсами.',
        date: '2026-01-27',
        image: 'https://static.tildacdn.com/tild6230-6637-4333-b730-663833323264/d_1.png',
        categories: ['ОГЭ'],
        author: 'ekaterina-zimnina',
    },
    {
        id: 16,
        article: 'kak-pomoch-podrostku-spravitsya-so-stressom',
        articleTitle: 'Как помочь подростку справиться со&nbsp;стрессом в&nbsp;школе',
        articleDescription: 'Как помочь подростку справиться со&nbsp;стрессом? Признаки, источники, техники релаксации и&nbsp;советы родителям. Когда обращаться к&nbsp;психологу и&nbsp;как репетитор снижает тревогу. Простые шаги для поддержки!',
        date: '2026-01-29',
        image: 'https://static.tildacdn.com/tild3862-6266-4639-b232-356538343439/d_2.jpg',
        categories: ['Психология'],
        author: 'elena-novikova',
    },
    {
        id: 17,
        article: 'perevyornutyj-klass-pedagogicheskaya-tekhnologiya-i-kak-ona-rabotaet',
        articleTitle: 'Технология «перевёрнутый класс»: как работает и преимущества для детей',
        articleDescription: 'Перевернутый класс — педагогическая методика, где теория изучается дома, а практика на занятии. Как работает, преимущества, применение для ОГЭ/ЕГЭ — рассказываем в статье.',
        date: '2026-02-03',
        image: 'https://static.tildacdn.com/tild3434-6232-4765-b730-656462306234/d_1.png',
        categories: ['Предметы'],
        author: 'viktoriya-petushkova',
    },
    {
        id: 18,
        article: 'kak-provesti-interesnyj-urok-sovety-dlya-repetitorov',
        articleTitle: 'Как провести интересный урок: 10+&nbsp;советов для репетиторов',
        articleDescription: 'Как можно интересно провести урок, чтобы ребенок не&nbsp;отвлекался? Советы репетиторам: подготовка, удержание внимания онлайн, чек-лист, типичные ошибки и&nbsp;приёмы вовлечения для ОГЭ/ЕГЭ.',
        date: '2026-02-06',
        image: 'https://static.tildacdn.com/tild3534-3261-4631-a337-633361633637/d_1.png',
        categories: ['Советы', 'Новая'],
        author: 'svetlana-savinih',
        forTutor: true
    },
    {
        id: 19,
        article: 'skolko-ballov-nuzhno-nabrat-na-oge-po-matematike-chtoby-poluchit-3-4-ili-5',
        articleTitle: 'Сколько баллов нужно набрать на&nbsp;ОГЭ по&nbsp;математике, чтобы получить 3,&nbsp;4&nbsp;или&nbsp;5',
        articleDescription: 'Узнайте, сколько нужно набрать баллов на&nbsp;ОГЭ по&nbsp;математике для оценки 3,&nbsp;4&nbsp;и&nbsp;5. Таблица перевода баллов, минимальный порог, критерии оценивания и&nbsp;советы по&nbsp;подготовке&nbsp;&mdash; в&nbsp;статье.',
        date: '2026-02-09',
        image: 'https://static.tildacdn.com/tild6435-6236-4463-a331-633566333766/d_1.png',
        categories: ['ОГЭ'],
        author: 'ekaterina-maslennikova'
    },
    {
...
<div class="page-wrapper">
    ...
    <div class="sidebar-section">
        <div class="section-title mobile">Рубрики</div>
        <div class="categories-container mobile"></div>
    </div>
</div>
        ...
        <div class="search-container">
            ...
            <div class="search-icons">
                <svg class="search-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <g clip-path="url(#clip0_8782_253)">
                        <path d="M7.1251 13.2502C10.5079 13.2502 13.2502 10.5079 13.2502 7.1251C13.2502 3.7423 10.5079 1 7.1251 1C3.7423 1 1 3.7423 1 7.1251C1 10.5079 3.7423 13.2502 7.1251 13.2502Z" stroke="#87898F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M11.4562 11.4561L15 14.9999" stroke="#87898F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </g>
                    <defs>
                        <clipPath id="clip0_8782_253">
                            <rect width="16" height="16" fill="white"/>
                        </clipPath>
                    </defs>
                </svg>
                <svg class="clear-icon hidden" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path d="M14 2L2 14" stroke="#87898F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M2 2L14 14" stroke="#87898F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </div>
        </div>
        <div id="cardsContainer" class="cards-container"></div>
        <div class="load-more-container">
            <button id="loadMoreBtn" class="load-more-btn">Показать еще</button>
        </div>
    </div>
         <div class="sidebar desktop">
        <div class="sidebar-section">
            <h2 class="section-title">Рубрики</h2>
            <div class="categories-container"></div>
        </div>
        <div class="sidebar-section">
            <h2 class="section-title">Популярные статьи</h2>
            <div class="articles-container popular-articles"></div>
        </div>
        <div class="sidebar-section">
            <h2 class="section-title">Рекомендуем к прочтению</h2>
            <div class="articles-container recommended-articles"></div>
        </div>
...
const defaultCategories = [
    { name: "ОГЭ", article: "podgotovka-k-oge"},
    { name: "ЕГЭ", article: "podgotovka-k-ege"},
    { name: "Выбор репетитора", article: "vybor-repetitora"},
    { name: "Предметы", article: "shkolnye-predmety"},
    { name: "Новости", article: "novosti"},
    { name: "Психология", article: "detskaya-psikhologiya"}
];

const tutorCategories = [
    { name: "Советы", article: "sovety-repetitoram", isForTutor: true },
    { name: "Подготовка", article: "kak-podgotovit-k-ekzamenam", isForTutor: true },
    { name: "Пcихология", article: "psikhologiya-uchenikov", isForTutor: true },
    { name: "Онлайн-формат", article: "format-online-zanyatij", isForTutor: true },
];

const tutorPages = ['repetitoram'];
const tutorCategoryArticles = tutorCategories.map(cat => cat.article);

const defaultPopularArticleIds = [17, 19, 20];
const defaultRecommendedArticleIds = [1, 3, 2];
const tutorPopularArticleIds = [14, 18];
const tutorRecommendedArticleIds = [14, 18];
...
function isForTutorPage() {
    const path = window.location.pathname;
    const pathWithoutSlash = path.replace(/^\/|\/$/g, '');
    
    if (tutorPages.includes(pathWithoutSlash)) return true;
    if (tutorCategoryArticles.includes(pathWithoutSlash)) return true;
    
    const currentArticle = window.allArticles.find(article => article.article === pathWithoutSlash);
    if (currentArticle && currentArticle.forTutor === true) return true;
    
    return false;
}

function getCurrentCategories() {
    return isForTutorPage() ? tutorCategories : defaultCategories;
}

function getPopularArticleIds() {
    return isForTutorPage() ? tutorPopularArticleIds : defaultPopularArticleIds;
}

function getRecommendedArticleIds() {
    return isForTutorPage() ? tutorRecommendedArticleIds : defaultRecommendedArticleIds;
}
...
function getCategoryFromURL() {
    ...
    const isTutorPage = isForTutorPage();
    
    if (isTutorPage) {
        if (pathWithoutSlash === 'repetitoram') return null;
        
        const tutorCategory = tutorCategories.find(cat => cat.article === pathWithoutSlash);
        if (tutorCategory) return tutorCategory.name;
        
        const currentArticle = window.allArticles.find(article => article.article === pathWithoutSlash);
        if (currentArticle && currentArticle.categories && currentArticle.categories.length > 0) {
            return currentArticle.categories[0];
        }
        
        return null;
    }
    
    const defaultCategory = defaultCategories.find(cat => cat.article === pathWithoutSlash);
...
function renderCards(data, page, append = false) {
    ...
    if (!filteredData.length) {
        containers.forEach(container => container.innerHTML = '<p>Статьи не найдены</p>');
        return;
    }

    const start = (page - 1) * cardsPerPage;
    const end = Math.min(start + cardsPerPage, filteredData.length);
    ...
    containers.forEach(container => {
        ...
        if (pageData.length === 0) {
            ...
            pageData.forEach(item => {
                if (!item) return;
                const articleLink = `/${encodeURIComponent(item.article || item.id)}`;
                const card = document.createElement('div');
                card.className = 'card';
                const categoriesList = getCurrentCategories();
                card.innerHTML = `
                    <div style="display: flex; gap: 24px;">
                        <div class="image-container">
                            <div class="tags-on-image">
                                ${item.categories?.map(category => {
                                    if (category === 'Новая') return `<span class="new-tag">${category}</span>`;
                                    const cat = categoriesList.find(c => c.name === category);
                                    const articleUrl = cat ? cat.article : encodeURIComponent(category);
                                    return `<a href="/${articleUrl}" class="tag">${category}</a>`;
                                }).join('') || ''}
                            </div>
                            <a href="${articleLink}">
                        ...
                        <div class="info-container">
                            <div style="display: flex; flex-direction: column; gap: 12px;">
                                <a href="${articleLink}" class="title" style="text-decoration: none; color: inherit;">${item.articleTitle || 'Без заголовка'}</a>
                                <a href="${articleLink}" class="description" style="text-decoration: none; color: inherit;">${item.articleDescription || 'Без описания'}</a>
                            </div>
    ...
    renderLoadMoreButton(filteredData.length, page);
...
function renderSidebar() {
    ...
    const categoriesHtml = currentCategories && Array.isArray(currentCategories) && currentCategories.length > 0
        ? currentCategories.map(category => {
            ...
            if (isTutorPage) {
                if (category.article === pathWithoutSlash) {
                    isActive = true;
                }
            } else {
            ...
            return `
                <a href="/${category.article}" class="category${isActive ? ' active' : ''}" data-category="${category.name}">
                    ${category.name}
                </a>
            `;
        }).join('')
    ...
    const popularIds = getPopularArticleIds();
    const popularArticles = popularIds
        .map(id => window.allArticles.find(article => article.id === id))
        .filter(article => article)
        .filter(article => !isTutorPage || article.forTutor === true);
            ...
            <div class="popular-slider">
                <div class="popular-slides" id="popularSlides${index}">
                    ${popularArticles.map((article, slideIndex) => {
                        const articleLink = `/${encodeURIComponent(article.article || article.id)}`;
                        const categoriesList = getCurrentCategories();
                        return `
                            <div class="popular-slide" data-index="${slideIndex}">
                                <div class="popular-card">
                                    <div class="image-container">
                                        <div class="tags-on-image">
                                            ${article.categories?.map(category => {
                                                if (category === 'Новая') return `<span class="new-tag">${category}</span>`;
                                                const cat = categoriesList.find(c => c.name === category);
                                                const catUrl = cat ? cat.article : encodeURIComponent(category);
                                                return `<a href="/${catUrl}" class="tag" onclick="event.stopPropagation()">${category}</a>`;
                                            }).join('') || ''}
                                        </div>
                                        <a href="${articleLink}">
                                    ...
                                    <a href="${articleLink}" style="text-decoration: none; color: inherit; display: block;">
    ...
    const recommendedIds = getRecommendedArticleIds();
    ...
    sidebars.forEach((sidebar, sidebarIndex) => {
        ...
        if (popularContainer) {
            ...
            if (popularArticles.length > 1) initPopularSlider(`popularSlides${sidebarIndex}`);
        }
        const recommendedContainer = sidebar.querySelector('.recommended-articles');
        if (recommendedContainer) recommendedContainer.innerHTML = recommendedArticlesHtml;
    });
}
...
function initPopularSlider(slidesId) {
    ...
    if (slider) {
        slider.addEventListener('mouseenter', () => clearInterval(sliderInterval[slidesId]));
        slider.addEventListener('mouseleave', () => resetSliderTimer(slidesId));
    }
}
...
function filterArticles() {
    ...
    let filtered = window.allArticles || [];
    ...
    if (isTutorPage) {
        ...
        filtered = filtered.filter(article => article.forTutor === true);
        
        const currentTutorCategory = tutorCategories.find(cat => cat.article === pathWithoutSlash);
        if (currentTutorCategory) {
            filtered = filtered.filter(article => {
                return article.categories && article.categories.includes(currentTutorCategory.name);
            });
            selectedCategory = currentTutorCategory.name;
        } else if (pathWithoutSlash === 'repetitoram') {
            selectedCategory = 'for-tutor';
        }
    } 
    else {
        ...
        if (selectedCategory && selectedCategory !== 'for-tutor') {
            filtered = filtered.filter(article => {
...
function renderLoadMoreButton(totalItems, currentPage) {
    ...
    if (totalItems === 0 || totalItems <= cardsPerPage) {
        loadMoreBtns.forEach(btn => btn.style.display = 'none');
        return;
    }
    ...
    if (currentPage < totalPages) {
        ...
        const updatedBtns = document.querySelectorAll('.load-more-btn');
...
document.addEventListener('DOMContentLoaded', () => {
    if (!window.allArticles || !window.allArticles.length) {
        ...
        if (container) container.innerHTML = '<p>Не удалось загрузить статьи</p>';
        return;
    }
    window.allArticles.sort((a, b) => new Date(b.date) - new Date(a.date));
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function isTutorPage() {
        ...
        const tutorPages = ['tutors', 'repetitoram'];
        const tutorCategories = ['sovety-repetitoram', 'kak-podgotovit-k-ekzamenam', 'psikhologiya-uchenikov', 'format-online-zanyatij'];

        if (tutorPages.includes(currentPath)) return true;
        if (tutorCategories.includes(currentPath)) return true;

        if (window.allArticles && Array.isArray(window.allArticles)) {
            const currentArticle = window.allArticles.find(article => article.article === currentPath);
            if (currentArticle && currentArticle.forTutor === true) return true;
        }
    ...
    const BANNER_IMAGES = {
        DEFAULT: 'https://static.tildacdn.com/tild6665-6265-4131-b663-353630653036/card-blog_2.png',
        TUTOR: 'https://static.tildacdn.com/tild6435-3732-4737-b736-383733326438/card1.svg'
    };

    const BANNER_LINK = {
        DEFAULT: '/blog#lastform',
        TUTOR: '/stat-repetitorom'
    };
    ...
    function createBanner() {
        ...
        const bgImage = isTutor ? BANNER_IMAGES.TUTOR : BANNER_IMAGES.DEFAULT;
        const linkHref = isTutor ? BANNER_LINK.TUTOR : BANNER_LINK.DEFAULT;

        banners.forEach(banner => {
            banner.style.background = `url('${bgImage}') no-repeat center center / cover`;
            banner.innerHTML = `<a href="${linkHref}" class="banner-content"></a>`;
        });
    }

    function initStickyForOneBanner(banner) {
        const sidebar = banner.closest('.sidebar');
        const pageWrapper = banner.closest('.page-wrapper');
        ...
        function updatePosition() {
            ...
            requestAnimationFrame(() => {
                ...
                if (originalOffsetTop === undefined) {
                    originalOffsetTop = bannerRect.top + scrollY;
                }
                ...
                const stickStart = originalOffsetTop - topOffset;
                const stickEnd = wrapperBottom - bannerHeight - topOffset;
                ...
                if (scrollY < stickStart) {
                ...
                else if (scrollY >= stickStart && scrollY <= stickEnd) {
                    banner.style.position = 'fixed';
                    banner.style.top = topOffset + 'px';
                    banner.style.left = sidebarRect.left + 'px';
                    banner.style.right = 'auto';
                    const w = sidebarRect.width;
                    banner.style.width = w + 'px';
                    if (!savedWidth) savedWidth = w;
                }
                else {
                    ...
                    banner.style.width = (savedWidth || sidebarRect.width) + 'px';
                }
        ...
        function handleScroll() {
            if (!ticking) requestAnimationFrame(updatePosition);
        }
    ...
    function tryInit() {
        if (window.allArticles && Array.isArray(window.allArticles)) {
            createBanner();
            document.querySelectorAll('.sidebar-banner').forEach(banner => {
                initStickyForOneBanner(banner);
            });
        } else {
...
function getArticlesByAuthor(authorUrl) {
    if (!authorUrl) return [];
    
    const authorArticles = window.allArticles.filter(article => {
        return article.author === authorUrl;
...
function createAuthorCard(article) {
    const articleLink = `/${article.article || article.id}`;
    
    const tagsHTML = article.categories?.map(category => {
        if (category === 'Новая') {
            return `<span class="author-new-tag">${category}</span>`;
        }

        const categorySlug = category.toLowerCase().replace(/\s+/g, '-');
        return `<a href="/category/${categorySlug}" class="author-tag">${category}</a>`;
    }).join('') || '';
    
    return `
        <div class="author-article-card">
            <div class="author-image-container">
                <div class="author-tags-on-image">
                    ${tagsHTML}
                </div>
                <a href="${articleLink}">
                    <img src="${article.image || ''}" alt="${article.articleTitle || 'Статья'}" loading="lazy" />
                </a>
            </div>
            <div class="author-info-container">
                <a href="${articleLink}" class="author-title">${article.articleTitle || 'Без заголовка'}</a>
                <a href="${articleLink}" class="author-description">${article.articleDescription || 'Без описания'}</a>
                <div class="author-date">${article.date ? new Date(article.date).toLocaleDateString('ru-RU', {
                    day: 'numeric', month: 'long', year: 'numeric'
                }) : 'Дата неизвестна'}</div>
            </div>
        </div>
...
function renderAuthorArticles() {
    const container = document.querySelector('.autor-container-articles');
    if (!container) return;
    
    const authorUrl = getCurrentAuthor();
    
    if (!authorUrl) {
        container.innerHTML = '<p>Статьи автора не найдены</p>';
        return;
    }
    
    const authorArticles = getArticlesByAuthor(authorUrl);
    ...
    const cardsHTML = authorArticles.map(article => createAuthorCard(article)).join('');
...
document.addEventListener('DOMContentLoaded', initAuthorArticles);
...
function createSameArtCard(article) {
    const articleUrl = article.article;

    const tagsHTML = article.categories?.map(category => {
        if (category === 'Новая') {
            return `<a href="/category/novaya" class="sameart-new-tag">${category}</a>`;
        }

        const defaultCat = window.defaultCategories?.find(c => c.name === category);
        if (defaultCat) {
            return `<a href="/${defaultCat.article}" class="sameart-tag">${category}</a>`;
        }
        
        const tutorCat = window.tutorCategories?.find(c => c.name === category);
        if (tutorCat) {
            return `<a href="/${tutorCat.article}" class="sameart-tag">${category}</a>`;
        }
        
        return `<span class="sameart-tag">${category}</span>`;
    }).join('') || '';

    return `
        <div class="sameart-article-card">
            <div class="sameart-image-container">
                <div class="sameart-tags-on-image">
                    ${tagsHTML}
                </div>
                <a href="/${articleUrl}">
                    <img src="${article.image || ''}" alt="${article.articleTitle || 'Статья'}" loading="lazy" />
            ...
            <div class="sameart-info-container">
                <a href="/${articleUrl}" class="sameart-title">${article.articleTitle || 'Без заголовка'}</a>
                <a href="/${articleUrl}" class="sameart-description">${article.articleDescription || 'Без описания'}</a>
                <div class="sameart-date">${article.date ? new Date(article.date).toLocaleDateString('ru-RU', {
                    day: 'numeric', month: 'long', year: 'numeric'
                }) : 'Дата неизвестна'}</div>
            </div>
        </div>
...
function getCurrentArticle() {
    const currentUrl = getCurrentArticleUrl();
    return window.allArticles.find(article => article.article === currentUrl);
}

function renderSameArtArticles() {
    const container = document.querySelector('.sameart-articles');
    if (!container) return;
    
    const currentArticle = getCurrentArticle();
    
    if (!currentArticle) {
        container.innerHTML = '<p>Статьи по похожей теме не найдены</p>';
        return;
    }

    const currentCategories = (currentArticle.categories || [])
        .filter(category => category !== 'Новая');
    ...
    const filteredArticles = window.allArticles
        .filter(article => {
            if (article.article === currentArticle.article) return false;
            
            if (!article.categories || article.categories.length === 0) return false;
            
            return article.categories.some(category => {

                if (category === 'Новая') return false;
    ...
    const cardsHTML = filteredArticles.map(article => createSameArtCard(article)).join('');
    container.innerHTML = cardsHTML;
}

function initSameArtArticles() {
    if (window.allArticles && window.allArticles.length > 0) {
        renderSameArtArticles();
    } else {
        const checkArticles = setInterval(() => {
            if (window.allArticles && window.allArticles.length > 0) {
                clearInterval(checkArticles);
...
document.addEventListener('DOMContentLoaded', initSameArtArticles);
if (document.readyState === 'interactive' || document.readyState === 'complete') {
    initSameArtArticles();
}
...
document.addEventListener('click', (e) => {
    ...
    if (dropdown && !e.target.closest('.share-button') && !e.target.closest('.share-dropdown')) {
        closeDropdown();
    }
    
    if (shareButton) {
        if (dropdown && dropdown.parentElement.contains(shareButton)) {
            closeDropdown();
            return;
        }
        
        createDropdown(shareButton);
    }
});
...
function createDropdown(button) {
    ...
    const text = encodeURIComponent('Вот это статья!');
    
    const networks = {
        vk: {
            url: `https://vk.com/share.php?url=${encodedUrl}&title=${title}`,
            name: 'Вконтакте',
            icon: 'vk-icon'
        },
        telegram: {
        ...
        ok: {
            url: `https://connect.ok.ru/dk?st.cmd=WidgetSharePreview&st.shareUrl=${encodedUrl}`,
            name: 'Одноклассники',
            icon: 'ok-icon'
        },
        copy: {
    ...
    for (let key in networks) {
        ...
        html += `
            <a href="${network.url}" class="share-item ${key === 'copy' ? 'copy-link' : ''}" 
               target="${key === 'copy' ? '_self' : '_blank'}" rel="${key === 'copy' ? '' : 'noopener noreferrer'}">
                <div class="icon ${network.icon}"></div>
                <div class="text">${network.name}</div>
            </a>
        `;
    }
    ...
    const copyButton = dropdown.querySelector('.copy-link');
    if (copyButton) {
...
function positionDropdownAboveButton(dropdown, button) {
    ...
    if (dropdown) {
        ...
        setTimeout(() => {
            if (dropdown.parentElement) {
                dropdown.parentElement.style.position = '';
            }
            dropdown.remove();
        }, 200);
    }
...
function copyLink(e, url) {
    ...
    navigator.clipboard.writeText(url).then(() => {
        ...
        button.querySelector('.text').textContent = 'Скопировано!';
...
//Прокрутка до ссылки в статье до определенного расстояния
...
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(function() {
        document.body.addEventListener('click', function(e) {
            ...
            if (link && link.closest('.article-content') && link.getAttribute('href') !== '#') {
                e.preventDefault();
...
//Вставка названия рубрики в хлебные крошки 

document.addEventListener('DOMContentLoaded', () => {
    const rubrika = document.querySelector('.rubrika');
    const nextLink = rubrika?.nextElementSibling;
    
    if (nextLink && nextLink.matches('a.breadcrumb-link')) {
        nextLink.remove();
    }
    ...
    const article = window.allArticles?.find(item => item.article === slug);
    if (!article || !article.categories?.length) return;

    const catName = article.categories[0];

    const breadcrumbNames = {
        "ОГЭ": "Подготовка к ОГЭ",
        "ЕГЭ": "Подготовка к ЕГЭ",
        "Выбор репетитора": "Как выбрать репетитора",
        "Предметы": "Школьные предметы",
        "Новости": "Новости образования",
        "Психология": "Детская психология",
        "Пcихология": "Психология учеников",
        "Советы": "Советы репетиторам",
        "Подготовка": "Как готовить к экзаменам",
        "Онлайн-формат": "Онлайн-занятия"
    };

    let catLink = null;
    let displayName = breadcrumbNames[catName] || catName;

    const tutorCat = tutorCategories.find(c => c.name === catName);
    if (tutorCat) {
        catLink = '/' + tutorCat.article;
    } else {
        const defaultCat = defaultCategories.find(c => c.name === catName);
        if (defaultCat) {
            catLink = '/' + defaultCat.article;
        }
    }

    if (!catLink) return;

    rubrika.href = catLink;
    rubrika.textContent = displayName;
});
...
//Контейнер с фидбеком
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const thanksBlocks = document.querySelectorAll('[id^="thanksBlock"]');
        const likeBtns = document.querySelectorAll('[id^="likeBtn"]');
        const dislikeBtns = document.querySelectorAll('[id^="dislikeBtn"]');
        ...
        dislikeBtns.forEach((dislikeBtn, index) => {
            dislikeBtn.addEventListener('click', function() {
                sendVote('dislike', index);
            });
        });
        
        function sendVote(voteType, index) {
            console.log(`Пользователь проголосовал: ${voteType} в блоке ${index}`);

            const btn = voteType === 'like' ? likeBtns[index] : dislikeBtns[index];
            ...
            if (thanksBlocks[index]) {
                thanksBlocks[index].style.display = 'flex';
                thanksBlocks[index].classList.add('fade-in');
            }
        }
    });


//Замена ссылки в футере

document.addEventListener('DOMContentLoaded', function() {
    const buttonElem = document.querySelector('[data-elem-id="1760598491648"]');
    
    if (buttonElem) {
        const link = buttonElem.querySelector('a.tn-atom[href="#lastform"]');
        if (link) {
            link.href = "/blog#lastform";
        }
    }
});
...
function applyNbsp() {
    const elements = document.querySelectorAll('h1, h2, h3, h4, h5, h6, p, li, td, th, span, div');
    
    elements.forEach(el => {
        if (el.children.length > 0 && !isSimpleTextElement(el)) {
            return;
        }
        ...
        html = html.replace(/(\s)(\u2014)(\s)/g, '$1<span style="white-space: nowrap;">\u2014</span>$3');
        html = html.replace(/\s(в|на|за|с|под|над|от|до|из|к|по|со|у|о|об|без|для|и|а|но|или|из-за|я|ты|он|мы|вы|они|ли|бы|же|не|ни)\s/gi, ' $1&nbsp;');
...
function isSimpleTextElement(el) {
    ...
    for (let i = 0; i < children.length; i++) {
        ...
        if (!['a', 'br', 'span', 'strong', 'em', 'b', 'i', 'mark', 'small', 'sub', 'sup'].includes(tagName)) {
            return false;
        }
    }
    return true;
...
function applyNbspToNode(node) {
    applyNbsp();
}

if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initNbspObserver);
} else {
    initNbspObserver();
}
...
const avtorsData = [
  {
    name: "Светлана Савиных",
    link: "/svetlana-savinih",
    backgroundDesktop: "url('https://static.tildacdn.com/tild3938-3463-4735-a336-613332633739/card1_3.png')",
    backgroundMobile: "url('https://static.tildacdn.com/tild3938-3463-4735-a336-613332633739/card1_3.png')"
  },
  {
    name: "Екатерина Масленникова",
    link: "/ekaterina-maslennikova",
    backgroundDesktop: "url('https://static.tildacdn.com/tild6466-3338-4533-b961-333261643263/card2_1.png')",
    backgroundMobile: "url('https://static.tildacdn.com/tild6466-3338-4533-b961-333261643263/card2_1.png')"
  },
  {
    name: "Ксения Лунегова",
    link: "/kseniya-lunegova",
    backgroundDesktop: "url('https://static.tildacdn.com/tild6466-3164-4163-a265-316230333266/card1-1_1.png')",
    backgroundMobile: "url('https://static.tildacdn.com/tild6466-3164-4163-a265-316230333266/card1-1_1.png')"
  },
  {
    name: "Дарья Тюрина",
    link: "/darya-tyurina",
    backgroundDesktop: "url('https://static.tildacdn.com/tild3439-6662-4833-b832-303963626131/card1-2_1.png')",
    backgroundMobile: "url('https://static.tildacdn.com/tild3439-6662-4833-b832-303963626131/card1-2_1.png')"
  },
  {
    name: "Елена Новикова",
    link: "/elena-novikova",
    backgroundDesktop: "url('https://static.tildacdn.com/tild3935-6561-4232-a462-323938313265/card1_1.png')",
    backgroundMobile: "url('https://static.tildacdn.com/tild3935-6561-4232-a462-323938313265/card1_1.png')"
  },
  {
    name: "Екатерина Зимнина",
    link: "/ekaterina-zimnina",
    backgroundDesktop: "url('https://static.tildacdn.com/tild3261-6463-4036-a565-333237393163/card1_3.png')",
    backgroundMobile: "url('https://static.tildacdn.com/tild3261-6463-4036-a565-333237393163/card1_3.png')"
  },
  {
    name: "Виктория Петушкова",
    link: "/viktoriya-petushkova",
    backgroundDesktop: "url('https://static.tildacdn.com/tild3233-3266-4233-b138-653935653430/card1_1.png')",
    backgroundMobile: "url('https://static.tildacdn.com/tild3233-3266-4233-b138-653935653430/card1_1.png')"
  }
];

document.addEventListener("DOMContentLoaded", () => {
  const currentPath = window.location.pathname.replace(/\/$/, "");
  const filtered = avtorsData.filter(a => a.link.replace(/\/$/, "") !== currentPath);
  const toShow = filtered.length > 0 ? filtered : avtorsData;
  const $slider = $(".avtors-slider");

  const createCard = (author) => {
    const bgDesk = author.backgroundDesktop;
    const bgMob = author.backgroundMobile || bgDesk;
    const parts = author.name.split(" ");
    const surname = parts[0];
    const rest = parts.slice(1).join(" ");

    return `
      <div class="avtor-card" style="--bg-desktop: ${bgDesk}; --bg-mobile: ${bgMob}; background: var(--bg-desktop) no-repeat center/cover;">
        <a href="${author.link}">
          <div class="avtor-header">
            <div class="avtor-label">Автор блога</div>
            <div class="avtor-name">${author.name}</div>
          </div>
          <div class="avtor-button">На страницу автора</div>
        </a>
      </div>
    `;
  };
  ...
  const updateBg = () => {
    document.querySelectorAll('.avtor-card').forEach(card => {
      const isMobile = window.innerWidth <= 1200;
      card.style.backgroundImage = isMobile 
        ? card.style.getPropertyValue('--bg-mobile')
        : card.style.getPropertyValue('--bg-desktop');
    });
  };

  $slider.html(toShow.map(createCard).join(""));

  let slidesToShow = 3;
  if (toShow.length === 2) slidesToShow = 2;
  if (toShow.length === 1) slidesToShow = 1;

  $slider.slick({
    slidesToShow: slidesToShow,
    slidesToScroll: 1,
    infinite: toShow.length > slidesToShow,
    arrows: true,
    prevArrow: '.avtor-slider-prev',
    nextArrow: '.avtor-slider-next',
    speed: 700,
...
window.allAuthors = {
    'svetlana-savinih': {
        name: 'Светлана Савиных',
        role: 'Автор блога',
        avatar: 'https://static.tildacdn.com/tild6634-3031-4530-b930-623035613139/d1.png',
        link: '/svetlana-savinih'
    },
    'ekaterina-maslennikova': {
        name: 'Екатерина Масленникова',
        role: 'Автор блога',
        avatar: 'https://static.tildacdn.com/tild3265-3036-4633-a638-346133336233/d2.png',
        link: '/ekaterina-maslennikova'
    },
    'kseniya-lunegova': {
        name: 'Ксения Лунегова',
        role: 'Автор блога',
        avatar: 'https://static.tildacdn.com/tild3830-3062-4138-b465-616237323762/d3_1.png',
        link: '/kseniya-lunegova'
    },
    'darya-tyurina': {
        name: 'Дарья Тюрина',
        role: 'Автор блога',
        avatar: 'https://static.tildacdn.com/tild6430-3139-4439-a132-613536643833/d4_1.png',
        link: '/darya-tyurina'
    },
    'elena-novikova': {
        name: 'Елена Новикова',
        role: 'Автор блога',
        avatar: 'https://static.tildacdn.com/tild3730-6530-4432-b764-623361323633/d4_1.png',
        link: '/elena-novikova'
    },
    'ekaterina-zimnina': {
        name: 'Екатерина Зимнина',
        role: 'Автор блога',
        avatar: 'https://static.tildacdn.com/tild3231-3733-4635-b430-643331303364/d4-1_1.png',
        link: '/ekaterina-zimnina'
    },
    'viktoriya-petushkova': {
        name: 'Виктория Петушкова',
        role: 'Автор блога',
        avatar: 'https://static.tildacdn.com/tild3635-3837-4162-b432-303031373762/d4.png',
        link: '/viktoriya-petushkova'
    }
};
...
function populateAuthorInfo() {
    ...
    const currentArticle = window.allArticles.find(article => 
    ...
    const authorData = window.allAuthors[currentArticle.author];
    ...
    if (authorLink) {
        authorLink.href = authorData.link;
    }
    if (authorAvatar) {
        authorAvatar.style.backgroundImage = `url('${authorData.avatar}')`;
    }
    if (authorName) {
        authorName.textContent = authorData.name;
    }
    if (authorRole) {
        authorRole.textContent = authorData.role;
    }
}

document.addEventListener('DOMContentLoaded', populateAuthorInfo);
...
function insertArticleDate() {
    ...
    if (!currentArticle || !currentArticle.date) return;
    
    const dateElement = document.querySelector('.article-date');
    if (dateElement) {
        dateElement.textContent = formatDate(currentArticle.date);
    }
}

document.addEventListener('DOMContentLoaded', insertArticleDate);
